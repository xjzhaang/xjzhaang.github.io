...
PhD researcher at École Polytechnique developing machine learning methods for biomedical imaging and biophysical signal analysis. Published in Science Advances, Physical Review X, and Communications Biology. Track record of delivering ML systems across interdisciplinary research and industry collaborations in medtech and clinical settings.
...
**Hot Flash Detection from Wearable Signals** | EloCare / NUS, Singapore 
<span class="date-right">2025 - Present</span>

- ML lead on an international collaboration with Singapore-based medtech startup EloCare, developing AI models for automated detection and prediction of hot flash events from wearable skin conductance signals.
